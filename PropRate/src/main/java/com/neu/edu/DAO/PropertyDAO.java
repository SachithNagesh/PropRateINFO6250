...
public void deleteProperty(int propId) throws AdException{
		
		try{
			begin();
				
			Query query = getSession().createQuery("delete from Property where propertyID = :propID");
			query.setInteger("propID",propId);
