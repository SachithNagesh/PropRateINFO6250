...
<body>
  <div class="body"></div>
		<div class="header">
			...
			<br>
			<h3 class="h4">Post a new Property</h3>
...
<tr>
    <td style="text-align:center;font-size: 15px;font-family: 'Exo', sans-serif;">Price:</td>
...
<tr><form:form action="property.htm" commandName="property" method="POST">
    <td colspan="2" style="text-align:center;font-size: 20px;font-family: 'Exo', sans-serif;"><font color="black"><input type="submit" value="Add Property" onclick="return addProperty() "/></font></td>
...
<br><font color="black">
<input type="submit" value="View properties posted" ></font>
