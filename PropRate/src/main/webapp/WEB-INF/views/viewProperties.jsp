...
<body>
  <div class="body"></div>
		<div class="header">
			...
			<h3 class="h4">Find Properties</h3>
			<br>
			<h3 class="h4">View Properties</h3>
		</div>
		<br>
		<br>
...
<br>
        <table border="1" cellpadding="5" cellspacing="5" class="table1 table-condensed" align="center">
            <tr>
                ...
                <td style="text-align:center;font-size: 20px;font-family: 'Exo', sans-serif;"><b>Interested</b>
            </tr>
            <c:forEach var="property" items="${properties}" begin="0" varStatus="counter" >
                <tr id="row${counter.index}">
                    ...
                    <td><button onclick="return applyProperty(${counter.index})" id="apply${counter.index}" align="center"> Like</button> 
                    </tr>
            </c:forEach>
        </table>
        </div>
